...
declare namespace preact {
  ...
  type AnyComponent<PropsType, StateType> =
  ...
  interface Component<PropsType, StateType> {
    ...
    componentDidUpdate(
      previousProps: Readonly<PropsType>,
      previousState: Readonly<StateType>,
      previousContext: any
    ): void
  }
  ...
  abstract class Component<PropsType, StateType> {
    ...
    setState<K extends keyof StateType>(
  ...
  function h<PropsType>(
    node: ComponentFactory<PropsType>,
    params: PropsType,
